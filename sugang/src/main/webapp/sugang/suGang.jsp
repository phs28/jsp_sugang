...
<div id="wrapper">
	...
	<form action="<%= request.getContextPath() %>/SuGang?choice=insert" method="post">
		<fieldset>
			...
			<button type="button" onclick="location.href='suInfo.jsp'">과목 상세조회</button>
		</fieldset>
		<fieldset>
		<table border="1">
			<tr>
		...
		<input class="h" type="submit" value="신청">
		</fieldset>
	</form>
	<form action="<%= request.getContextPath() %>/SuGang?choice=select" method="post">
	<fieldset>
		<legend>수강정보 조회</legend>
